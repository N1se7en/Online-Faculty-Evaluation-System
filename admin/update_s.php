...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "UPDATE `student` SET id='$id',fname='$fname',lname='$lname',id_number='$id_number',email='$email',pass='$password',
    course_1='$c1',course_2='$c2',course_3='$c3' WHERE id=$id";
    ...
    <div class="container col-md-7 offset-3">
        ...
        <form class="row g-3" method="POST">
            ...
            <div class="input-group">
                ...
                <input type="varchar" class="form-control" id="inputEmail4" placeholder="Example: 2018-1-60-203" name="id_number" autocomplete="off" value=<?php echo"$id_number"; ?>>
            </div>
            <div class="input-group">
                <span class="input-group-text">Email</span>
                <input type="email" class="form-control" id="inputEmail4" placeholder="Example: 2018-1-60-203@std.ewudbd.edu" name="email" autocomplete="off"value=<?php echo"$email"; ?>>
            </div>
            ...
            <div class="input-group">
                ...
                <select id="inputState" class="form-select" name="crs1">
                    <option selected><?php echo"$c1"; ?></option>
                    <?php
            ...
            <div class="input-group">
                ...
                <select id="inputState" class="form-select" name="crs2">
                    <option selected><?php echo"$c2"; ?></option>
                    <?php
            ...
            <div class="input-group">
                ...
                <select id="inputState" class="form-select" name="crs3">
                    <option selected><?php echo"$c3"; ?></option>
                    <?php
